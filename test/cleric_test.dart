...
void main() {
  ...
  test('pray()를 하면 기도 시간 + 0~2의 마나만큼 회복한 량을 return 해야한다.', () {
    final mp = 1;
    final cleric = Cleric(name: '클레릭', mp: mp, maxMp: 10);
    final prayResult = cleric.pray(3);

    expect(prayResult, lessThanOrEqualTo(5));
    expect(prayResult, greaterThanOrEqualTo(3));
